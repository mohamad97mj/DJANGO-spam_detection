...
from main.filters.utils import FileUtils, Logger, PandasUtils
from main.filters.fasttext_filter.preprocessor import Preprocessor
from os import path
...
class Model:
    ...
    def __init__(self, rebuild_model=True):
